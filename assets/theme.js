...
import { animate, timeline as timeline2, stagger } from "//ofthesun.vn/cdn/shop/t/15/assets/vendor.min.js?v=52426788336887041471710498254";
...
import { stagger as stagger2 } from "//ofthesun.vn/cdn/shop/t/15/assets/vendor.min.js?v=52426788336887041471710498254";
...
import { animate as animate2, stagger as stagger3, inView } from "//ofthesun.vn/cdn/shop/t/15/assets/vendor.min.js?v=52426788336887041471710498254";
...
import { inView as inView2 } from "//ofthesun.vn/cdn/shop/t/15/assets/vendor.min.js?v=52426788336887041471710498254";
...
import { timeline as timeline3, inView as inView3 } from "//ofthesun.vn/cdn/shop/t/15/assets/vendor.min.js?v=52426788336887041471710498254";
...
import { animate as animate3 } from "//ofthesun.vn/cdn/shop/t/15/assets/vendor.min.js?v=52426788336887041471710498254";
...
import { animate as animate4 } from "//ofthesun.vn/cdn/shop/t/15/assets/vendor.min.js?v=52426788336887041471710498254";

// js/common/overlay/dialog-element.js
import { FocusTrap, Delegate } from "//ofthesun.vn/cdn/shop/t/15/assets/vendor.min.js?v=52426788336887041471710498254";
...
import { animate as motionAnimate, timeline as motionTimeline } from "//ofthesun.vn/cdn/shop/t/15/assets/vendor.min.js?v=52426788336887041471710498254";
...
import { animate as motionAnimate2, timeline as motionTimeline2 } from "//ofthesun.vn/cdn/shop/t/15/assets/vendor.min.js?v=52426788336887041471710498254";
...
import { Delegate as Delegate2 } from "//ofthesun.vn/cdn/shop/t/15/assets/vendor.min.js?v=52426788336887041471710498254";
...
import { animate as animate5 } from "//ofthesun.vn/cdn/shop/t/15/assets/vendor.min.js?v=52426788336887041471710498254";
...
import { animate as animate6, timeline as timeline4, stagger as stagger4 } from "//ofthesun.vn/cdn/shop/t/15/assets/vendor.min.js?v=52426788336887041471710498254";
...
import { Delegate as Delegate3 } from "//ofthesun.vn/cdn/shop/t/15/assets/vendor.min.js?v=52426788336887041471710498254";
...
import { PhotoSwipeLightbox } from "//ofthesun.vn/cdn/shop/t/15/assets/vendor.min.js?v=52426788336887041471710498254";
var ProductGallery = class extends HTMLElement {
  ...
  get photoswipe() {
    ...
    const photoswipe = new PhotoSwipeLightbox({
      pswpModule: () => import("//ofthesun.vn/cdn/shop/t/15/assets/photoswipe.min.js?v=20290624223189769891710498254"),
      bgOpacity: 1,
  ...
  _onObserved(entries) {
    entries.forEach((entry) => {
      if (entry.target === this._scopeFrom) {
        this.#scopeFromVisible = entry.isIntersecting;
      }
    });

    // Nếu nút add-to-cart **đang không hiển thị** → hiện nút treo
    this.classList.toggle("is-visible", !this.#scopeFromVisible);
  }
};
...
import { animate as animate7, timeline as timeline5 } from "//ofthesun.vn/cdn/shop/t/15/assets/vendor.min.js?v=52426788336887041471710498254";
...
import { inView as inView4 } from "//ofthesun.vn/cdn/shop/t/15/assets/vendor.min.js?v=52426788336887041471710498254";
...
import { timeline as timeline6 } from "//ofthesun.vn/cdn/shop/t/15/assets/vendor.min.js?v=52426788336887041471710498254";
...
import { animate as animate8 } from "//ofthesun.vn/cdn/shop/t/15/assets/vendor.min.js?v=52426788336887041471710498254";
...
import { animate as animate9 } from "//ofthesun.vn/cdn/shop/t/15/assets/vendor.min.js?v=52426788336887041471710498254";
...
import { animate as animate10, inView as inView5 } from "//ofthesun.vn/cdn/shop/t/15/assets/vendor.min.js?v=52426788336887041471710498254";
...
// js/theme.js
import { Delegate as Delegate4 } from "//ofthesun.vn/cdn/shop/t/15/assets/vendor.min.js?v=52426788336887041471710498254";
(() => {
